...
app.get("/", async function(req, res){
      ...
      let apiUrl = `https://api.unsplash.com/photos/random/?client_id=WlzGPg6_xAU6rzC0u8s3hegzCmTU8IDvP66meKgA5IA&featured=true&orientation=landscape`;
...
app.get("/search", async function(req, res){
      ...
      let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=WlzGPg6_xAU6rzC0u8s3hegzCmTU8IDvP66meKgA5IA&featured=true&orientation=landscape&query=${keyword}`;
      let response = await fetch(apiUrl);
      let data = await response.json();
